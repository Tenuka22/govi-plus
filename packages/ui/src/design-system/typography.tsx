...
const createComponent = <T extends HTMLElement>(
  ...
  const Component = forwardRef<T, HTMLAttributes<T>>((props, ref) => {
...
export const XSmall = createComponent<HTMLParagraphElement>(
  'span',
...
export const LinkCode = createComponent<HTMLUListElement>(
  'span',
